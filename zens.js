...
const nyoutube = ('© Fahri ???')  //ubah di config biar ngk emror
...
*Silahkan* @${m.mentionedJid[0].split`@`[0]} *untuk ketik terima/tolak*`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                zens.sendMessage(m.chat, { image: { url: 'https://i.postimg.cc/mDN7tJqF/fahri.png' }, caption: `*${ucapanWaktu} Kak ${m.pushName}*\n\n *Jika ingin berdonasi silahkan scan gambar diatas*\n\n*Jika ingin sewa bot atau premium*\n*Silahkan Chat Owner*\n\n*Atau klik link dibawah ini*\n_https://saweria.co/\n\n*Atau Transfer via*\n- *Gopay Dana Ovo Qris ShopeePay*\n chat nomor berikut : wa.me/6283172862360\n\n_Terima kasih_` }, { quoted: m })
            }
            break 
            case 'chat': {
...
break
case 'bot': {
               list = ['./sound/oy.mp3','./sound/kenapa.mp3','./sound/iya.mp3','./sound/hai.mp3','./sound/hadroh.mp3']
...
break
case 'anjing': {
               goblok = fs.readFileSync('./sound/anjing.mp3')
zens.sendMessage(m.chat, {audio: goblok, mimetype:'audio/mpeg', ptt:true }, {quoted:m})}
break
case 'sc': {
